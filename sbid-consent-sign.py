...
# Fetch jwks.json, prepare the public key. If production, replace "preprod" with "id" in the url.
...
""" 'login_hint' needs to be a Swedish BankID test-user setup with the mobile app!
